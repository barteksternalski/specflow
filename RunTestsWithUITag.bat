REM
packages\NUnit.ConsoleRunner.3.6.1\tools\nunit3-console.exe SpecflowTests.nunit /config:Debug --where "cat == UI" --labels=All --out=TestResults\TestResult.txt "--result=TestResults\TestResult.xml;format=nunit2"
