REM
packages\NUnit.ConsoleRunner.3.6.1\tools\nunit3-console.exe SpecflowTests.nunit /config:Debug --where "cat == API" --labels=All --out=TestResults\TestResult.txt "--result=TestResults\TestResult.xml;format=nunit2"
